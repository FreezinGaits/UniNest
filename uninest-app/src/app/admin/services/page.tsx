...
export default async function ServiceOrdersPage() {
  let items: any[] = [];
  const tableType = 'services' as string;
  try {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-text-primary">Service Orders</h1>
          <p className="text-text-secondary mt-1">Platform service requests (Cleaning, Plumbing, Laundry)</p>
        </div>
      ...
      {items.length > 0 ? (
        ...
        <Card>
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="text-sm text-text-secondary max-w-md mt-1 mb-4">Platform service requests (Cleaning, Plumbing, Laundry)</p>
