...
export default async function MaintenanceTicketsPage() {
  let items: any[] = [];
  const tableType = 'maintenance' as string;
  try {
    ...
    <div className="space-y-6 animate-fade-in">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-text-secondary mt-1">Platform-wide maintenance & emergency requests</p>
        </div>
      ...
      {items.length > 0 ? (
        ...
        <Card>
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="text-sm text-text-secondary max-w-md mt-1 mb-4">Platform-wide maintenance & emergency requests</p>
