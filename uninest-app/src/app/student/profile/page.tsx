...
export default async function StudentProfilePage() {
  let items: any[] = [];
  const tableType = 'profile' as string;
  try {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-text-primary">Student Profile</h1>
          <p className="text-text-secondary mt-1">Personal details, college info, and preferences</p>
        </div>
      ...
      {items.length > 0 ? (
        ...
        <Card>
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <h3 className="text-base font-semibold text-text-primary">Student Profile</h3>
            <p className="text-sm text-text-secondary max-w-md mt-1 mb-4">Personal details, college info, and preferences</p>
