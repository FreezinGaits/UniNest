...
export default async function EarningsPayoutsPage() {
  let items: any[] = [];
  const tableType = 'providerEarnings' as string;
  try {
    ...
    <div className="space-y-6 animate-fade-in">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-text-secondary mt-1">Track job payouts after UniNest commission</p>
        </div>
      ...
      {items.length > 0 ? (
        ...
        <Card>
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="text-sm text-text-secondary max-w-md mt-1 mb-4">Track job payouts after UniNest commission</p>
