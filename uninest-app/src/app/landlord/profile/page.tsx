...
export default async function LandlordProfilePage() {
  let items: any[] = [];
  const tableType = 'landlordProfile' as string;
  try {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-text-primary">Landlord Profile</h1>
          <p className="text-text-secondary mt-1">Business profile, bank details for payouts, and contact info</p>
        </div>
      ...
      {items.length > 0 ? (
        ...
        <Card>
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <h3 className="text-base font-semibold text-text-primary">Landlord Profile</h3>
            <p className="text-sm text-text-secondary max-w-md mt-1 mb-4">Business profile, bank details for payouts, and contact info</p>
